...
## Command Palette & Global Controls
...
| **Inline Monospace Code** | `Ctrl + E` | `Cmd + E` |
| **Heading Levels 1 through 6** | `Ctrl + Alt + 1..6` | `Cmd + Alt + 1..6` |
