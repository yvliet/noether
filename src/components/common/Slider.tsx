...
export const Slider: React.FC<SliderProps> = React.memo(({
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full h-[6px] bg-[var(--noether-border-strong,#333333)] border border-[var(--noether-border-base,#404040)] shadow-[inset_0_1px_2px_rgba(0,0,0,0.35)] rounded-full overflow-hidden relative ${trackClassName}`}
      >
