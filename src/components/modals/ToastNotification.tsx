...
export const ToastNotification: React.FC = React.memo(() => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[9999] pointer-events-auto select-none">
      <div
        onClick={hideToast}
        className="flex items-center gap-2 px-3.5 py-2 bg-[var(--noether-bg-popover,#202020)] border border-[var(--noether-border-base,#333333)] text-[var(--noether-text-primary,#e0e0e0)] text-xs rounded-lg shadow-2xl cursor-pointer hover:bg-[var(--noether-bg-card-hover,#252525)]"
      >
