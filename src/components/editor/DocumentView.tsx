      ...
      editorProps: {
        ...
        handleDOMEvents: {
          ...
          click: (view, event) => {
            ...
            const checkbox = targetEl?.closest<HTMLInputElement>('input[type="checkbox"]');
            if (checkbox && !view.editable) {
            ...
            const linkEl = targetEl?.closest('.md-link, .md-wikilink, a');
            if (linkEl) {
              const href = linkEl.getAttribute('href');
              const target = linkEl.getAttribute('data-wikilink-target') || linkEl.getAttribute('data-target');
              if (target) {
                event.preventDefault();
                event.stopPropagation();
