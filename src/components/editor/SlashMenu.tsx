                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline gap-1.5 min-w-0">
                        <span className="font-normal text-sm text-[var(--noether-text-primary)] truncate">
                          {item.title}
                        </span>
                        {item.badge && (
                  ...
                  {hasSub && (
                    <ChevronRightIcon
                      size={14}
                      className={`shrink-0 ${
                        activeSubmenu === itemSubId ? 'text-[var(--noether-text-primary)]' : 'text-[var(--noether-text-muted)]'
                      }`}
                    />
                  )}
                </button>
