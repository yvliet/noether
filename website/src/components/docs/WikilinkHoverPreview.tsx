...
export const WikilinkHoverPreview: React.FC<WikilinkHoverPreviewProps> = React.memo(({
  ...
  return createPortal(
    <div
      ...
      className="z-[9999] pointer-events-auto flex flex-col rounded-xl border border-[#2e2e2e] bg-[#161616] shadow-[0_16px_40px_rgba(0,0,0,0.65)] overflow-hidden text-left"
    >
