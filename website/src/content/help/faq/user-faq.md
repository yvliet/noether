...
If there is a specific workflow or plugin you depend on that is not yet available in Noether, reach out directly in the [Noether Discord Server](https://dsc.gg/noether). Share what features you rely on, and I will see if I can build a native Noether extension for you. You can also file bug reports and feature requests on [GitHub Issues](https://github.com/yvliet/noether/issues).
